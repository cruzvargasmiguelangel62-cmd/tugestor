           ...
           <div className="space-y-3 sm:space-y-4">
             {catalog.map(item => (
                <div 
                  ...
                  className={`bg-white p-4 sm:p-5 rounded-xl lg:rounded-2xl shadow-sm border flex justify-between items-center cursor-pointer transition-all active:scale-[0.99] lg:hover:shadow-md ${
                    editingId === item.id 
