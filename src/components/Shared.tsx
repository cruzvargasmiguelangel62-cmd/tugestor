...
const NavBtn: React.FC<NavBtnProps> = memo(({ icon, label, active, onClick }) => (
  <button
    ...
    className={`group flex flex-col items-center justify-center w-16 py-1 gap-1 transition-all duration-200 active:scale-95 ${active ? 'text-slate-900' : 'text-slate-400 hover:text-slate-600'
      }`}
  >
